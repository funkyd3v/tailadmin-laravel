...
<head>
    ...
    <link rel="icon" href="favicon.ico"><link href="{{ asset('assets/css/style.css') }}" rel="stylesheet">
</head>
    ...
    <div class="relative p-6 bg-white dark:bg-gray-900 sm:p-0">
        <div class="flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ __('Enter your details to create an account!') }}
                        </p>
                    </div>
                    @if (session('status'))
                            ...
                            {{-- <div>
                                <div x-data="{ checkboxToggle: false }">
                                    <label for="checkboxLabelOne"
                                        ...
                                        <div class="relative">
                                            <input type="checkbox" id="checkboxLabelOne" name="terms" class="sr-only"
                                        ...
                                        <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                                            ...
                                            <a href="{{ route('terms') }}" class="text-gray-800 dark:text-white/90">
                                                {{ __('Terms and Conditions') }},
                                            </a>
                                            {{ __('and our') }}
                                            <a href="{{ route('privacy') }}" class="text-gray-800 dark:text-white">
                                                {{ __('Privacy Policy') }}
                                            </a>
                                        </p>
                                    </label>
                ...
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            {{ __('Welcome to our platform! Sign up to explore more features and stay connected.') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="fixed z-50 hidden bottom-6 right-6 sm:block">
                <button class="inline-flex items-center justify-center text-white transition-colors rounded-full size-14 bg-brand-500 hover:bg-brand-600"
